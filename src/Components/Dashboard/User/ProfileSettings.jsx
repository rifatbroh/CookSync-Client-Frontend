...
const UpdatePreferencesForm = ({ onUpdate, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setMessage("");
    try {
      await axios.patch("/users/preferences", preferences);
      setMessage("✅ Preferences updated successfully.");
      if (onUpdate) {
        await onUpdate(); // notify parent to refresh data and close modal
      }
    } catch (err) {
